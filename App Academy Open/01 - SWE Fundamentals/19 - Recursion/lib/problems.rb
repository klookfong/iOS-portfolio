...
#pow(5, 10) => 5 * pow(5,9) => 5 * pow(5, 8)...... * pow(5,0) (which is 1) => multiplying 5 times itself exponent amount of times until exponent = 1.
...
def sum_array(array)
    ...
    left=array[0...midi]
    right=array[midi..-1]
    return sum_array(left) + sum_array(right)
