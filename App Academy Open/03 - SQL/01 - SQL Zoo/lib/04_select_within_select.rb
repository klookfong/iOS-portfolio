...
def population_constraint
  ...
  where population between (select population from countries where name = 'Canada') 
    and (select population from countries where name = 'Poland') and name not in ('Canada', 'Poland')
  SQL
end
